(function (global) {
  function createToolsKit(ReactLib, graphCoreInput) {
    ...
    function GraphWorkspace(props) {
      ...
      const validRows = compiledRows.filter((row) => row.enabled && row.compiled?.ok);
      const viewSummary = {
        xMin: formatNumber(graph.view.xMin),
        xMax: formatNumber(graph.view.xMax),
        yMin: formatNumber(graph.view.yMin),
        yMax: formatNumber(graph.view.yMax),
      };
      ...
      return h("div", { className: "ypt-graph-shell" }, [
          ...
          [
            h("div", { key: "copy" }, [
              ...
              h(
                "p",
                { key: "title", className: "ypt-tool-workspace-title" },
                  zh ? "函數圖形工作區" : "Function graph workspace",
              ),
            ]),
            h(
              "button",
        ...
        h("div", { key: "workspace", className: "ypt-graph-workspace" }, [
            ...
            graph.showTable
              ? h("div", { key: "table", className: "ypt-graph-table" }, [
                  ...
                  h("div", { key: "controls", className: "ypt-graph-table-controls" }, [
                    ...
                    h("div", { key: "count", className: "ypt-graph-table-field" }, [
                      h("label", { key: "label" }, zh ? "列數" : "rows"),
                      h("input", {
                        key: "input",
                        type: "number",
                        min: 5,
                        max: 15,
                        value: graph.table.count,
                        onChange: (event) =>
                          patchGraph((previous) => ({
                            ...previous,
                            table: {
          ...
          h("section", { key: "main", className: "ypt-graph-main" }, [
            ...
            h("div", { key: "status", className: "ypt-graph-statusbar" }, [
              h("div", { key: "selected", className: "ypt-graph-status-card" }, [
                h(
                  "div",
                  { key: "label", className: "ypt-graph-status-label" },
                  zh ? "目前函數" : "Selected expression",
                ),
                h(
                  "div",
                  { key: "value", className: "ypt-graph-status-value" },
                  selectedRow?.text || (zh ? "尚未輸入" : "No expression yet"),
                ),
              ]),
              h("div", { key: "range", className: "ypt-graph-status-card" }, [
                h(
                  "div",
                  { key: "label", className: "ypt-graph-status-label" },
                  zh ? "視窗範圍" : "Viewport range",
                ),
                h(
                  "div",
                  { key: "value", className: "ypt-graph-status-value" },
              ...
              h("div", { key: "trace", className: "ypt-graph-status-card" }, [
                h(
                  "div",
                  { key: "label", className: "ypt-graph-status-label" },
                  zh ? "追蹤" : "Trace",
                ...
                h(
                  ...
                  trace
                    ...
                    : zh
                      ? "移到曲線上檢視座標"
                      : "Hover the curve to inspect coordinates",
                ),
              ]),
              h("div", { key: "rows", className: "ypt-graph-status-card" }, [
                h(
                  "div",
                  { key: "label", className: "ypt-graph-status-label" },
                  zh ? "可見圖形" : "Visible plots",
                ),
                h(
                  "div",
                  { key: "value", className: "ypt-graph-status-value" },
                  validRows.length + " / " + compiledRows.length,
                ),
              ]),
            ]),
            h("div", { key: "range-controls", className: "ypt-graph-range-controls" }, [
              [
                ["xMin", zh ? "x 最小" : "x min"],
                ["xMax", zh ? "x 最大" : "x max"],
                ["yMin", zh ? "y 最小" : "y min"],
                ...
                h("label", { key: field, className: "ypt-graph-range-field" }, [
                  h("span", { key: "label" }, label),
                  h("input", {
                    key: "input",
                    type: "number",
                    value: graph.view[field],
                    onChange: (event) =>
                      patchGraph((previous) => ({
                        ...previous,
                        view: normalizeGraphViewShape({
